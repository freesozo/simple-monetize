...
const I18n = (() => {
  const dict = {
    ja: {
      ...
      recentlyAddedHeading: '最近追加されたツール',
      // Theme
      ...
      // Simulator
      navSimulator: '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> シミュレーター',
      simBreadcrumb: '料金シミュレーター',
      simTitle: 'ツール料金シミュレーター',
      simSubtitle: '月額予算を入力して、最適なツールの組み合わせを見つけよう',
      simBudgetLabel: '月額予算',
      simBudgetSuffix: '円/月',
      simCategoryLabel: '必要なツール（複数選択可）',
      simCatServer: 'レンタルサーバー',
      simCatVPN: 'VPN',
      simCatAI: 'AIツール',
      simCatDesign: 'デザインツール',
      simCatLearning: '学習サービス',
      simPriorityLabel: '重視するポイント',
      simPriCost: 'コスパ重視',
      simPriPerf: '性能重視',
      simPriBalance: 'バランス',
      simStartBtn: 'シミュレーション開始',
    },
    en: {
      ...
      recentlyAddedHeading: 'Recently Added Tools',
      // Theme
      ...
      // Simulator
      navSimulator: '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> Simulator',
      simBreadcrumb: 'Pricing Simulator',
      simTitle: 'Tool Pricing Simulator',
      simSubtitle: 'Enter your monthly budget and find the optimal tool combination',
      simBudgetLabel: 'Monthly Budget',
      simBudgetSuffix: '/mo',
      simCategoryLabel: 'Tools You Need (multiple)',
      simCatServer: 'Web Hosting',
      simCatVPN: 'VPN',
      simCatAI: 'AI Tools',
      simCatDesign: 'Design Tools',
      simCatLearning: 'Learning',
      simPriorityLabel: 'Priority',
      simPriCost: 'Best Value',
      simPriPerf: 'Performance',
      simPriBalance: 'Balanced',
      simStartBtn: 'Start Simulation',
    }
  };
